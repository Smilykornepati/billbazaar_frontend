...
class _ReportsScreenState extends State<ReportsScreen> {
  ...
  // Date filter and tabs section - exact match to design
  ...
  Widget _buildMainContent() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          // Today's Sales Card - exact match to design
  ...
  // Metrics Cards - exact match to design
  ...
  // Individual metric card - exact match to design
  ...
  // Top Selling Products - exact match to design
  ...
  // Product item widget - exact match to design
  ...
  // Low Stock Alert - exact match to design
  ...
  // Stock item widget - exact match to design
